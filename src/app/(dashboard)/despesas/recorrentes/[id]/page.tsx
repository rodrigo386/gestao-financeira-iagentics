  ...
  return (
    <div className="space-y-6">
      ...
      <div className="border rounded-md p-4 space-y-3 max-w-xl text-sm">
        ...
        <div className="grid grid-cols-2 gap-2">
          <span className="text-neutral-500">Dia do mês</span>
          <span>{recorrente.dia_mes}</span>
        </div>
        <div className="grid grid-cols-2 gap-2">
          <span className="text-neutral-500">Data início</span>
          <span>{recorrente.data_inicio}</span>
        </div>
        {recorrente.data_fim && (
          <div className="grid grid-cols-2 gap-2">
            <span className="text-neutral-500">Data fim</span>
            <span>{recorrente.data_fim}</span>
          </div>
        )}
        <div className="grid grid-cols-2 gap-2">
          <span className="text-neutral-500">Próxima geração</span>
